...
public class ClockView extends View {
    ...
    private void drawDial(Canvas canvas){
        //时钟用长一点的刻度，画笔用画圆的画笔
        PointDotBean hourStartPoint = new PointDotBean(circleX,circleY-circleRadius);
        PointDotBean hourEndPoint = new PointDotBean(circleX,circleY-circleRadius+40);
        //分钟的刻度要稍微短一些，画笔用画圆的画笔
        PointDotBean startPoint2 = new PointDotBean(circleX,circleY-circleRadius);
        PointDotBean endPoint2 = new PointDotBean(circleX,circleY-circleRadius+10);
